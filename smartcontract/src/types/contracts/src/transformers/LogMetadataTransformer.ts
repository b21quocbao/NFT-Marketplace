...
export interface LogMetadataTransformerInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "TransformerMetadata(address,address,bytes)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "TransformerMetadata"): EventFragment;
}

export interface TransformerMetadataEventObject {
  sender: string;
  taker: string;
  data: string;
}
export type TransformerMetadataEvent = TypedEvent<
  [string, string, string],
  TransformerMetadataEventObject
>;

export type TransformerMetadataEventFilter =
  TypedEventFilter<TransformerMetadataEvent>;
...
export interface LogMetadataTransformer extends BaseContract {
  ...
  filters: {
    "TransformerMetadata(address,address,bytes)"(
      sender?: null,
      taker?: null,
      data?: null
    ): TransformerMetadataEventFilter;
    TransformerMetadata(
      sender?: null,
      taker?: null,
      data?: null
