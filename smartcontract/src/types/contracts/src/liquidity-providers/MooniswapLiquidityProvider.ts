...
export interface MooniswapLiquidityProviderInterface extends utils.Interface {
  functions: {
...
export interface MooniswapLiquidityProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MooniswapLiquidityProviderInterface;
