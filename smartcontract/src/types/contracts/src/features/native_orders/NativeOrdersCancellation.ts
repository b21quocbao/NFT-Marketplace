...
export interface NativeOrdersCancellationInterface extends utils.Interface {
  functions: {
...
export interface NativeOrdersCancellation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NativeOrdersCancellationInterface;
