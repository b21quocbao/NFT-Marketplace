...
export interface IERC721OrdersFeatureInterface extends utils.Interface {
  functions: {
...
export interface IERC721OrdersFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721OrdersFeatureInterface;
