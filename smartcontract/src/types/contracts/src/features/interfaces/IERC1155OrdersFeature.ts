...
export interface IERC1155OrdersFeatureInterface extends utils.Interface {
  functions: {
...
export interface IERC1155OrdersFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC1155OrdersFeatureInterface;
