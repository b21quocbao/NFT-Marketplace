...
export interface MintableERC721TokenInterface extends utils.Interface {
  functions: {
...
export interface MintableERC721Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintableERC721TokenInterface;
