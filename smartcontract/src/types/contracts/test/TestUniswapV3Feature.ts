...
export interface TestUniswapV3FeatureInterface extends utils.Interface {
  functions: {
...
export interface TestUniswapV3Feature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestUniswapV3FeatureInterface;
