...
export interface TestFillQuoteTransformerHostInterface extends utils.Interface {
  functions: {
    "executeTransform(address,address,uint256,address,address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [string, string, BigNumberish, string, string, BytesLike]
  ): string;
  encodeFunctionData(
...
export interface TestFillQuoteTransformerHost extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestFillQuoteTransformerHostInterface;
