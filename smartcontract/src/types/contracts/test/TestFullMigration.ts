...
export interface TestFullMigrationInterface extends utils.Interface {
  functions: {
...
export interface TestFullMigration extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestFullMigrationInterface;
