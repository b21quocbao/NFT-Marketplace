...
export interface TestMintableERC1155TokenInterface extends utils.Interface {
  functions: {
...
export interface TestMintableERC1155Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMintableERC1155TokenInterface;
