...
export interface TestMetaTransactionsNativeOrdersFeatureInterface
  ...
  events: {
    "FillLimitOrderCalled(tuple,uint8,uint8,bytes32,bytes32,uint128,address,address)": EventFragment;
    "FillRfqOrderCalled(tuple,uint8,uint8,bytes32,bytes32,uint128,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "FillLimitOrderCalled"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "FillRfqOrderCalled"): EventFragment;
...
export interface FillLimitOrderCalledEventObject {
  order: LibNativeOrder.LimitOrderStructOutput;
  signatureType: number;
  v: number;
  r: string;
  s: string;
...
export type FillLimitOrderCalledEvent = TypedEvent<
  [
    LibNativeOrder.LimitOrderStructOutput,
    number,
    number,
    string,
    string,
  ...
  FillLimitOrderCalledEventObject
>;

export type FillLimitOrderCalledEventFilter =
  TypedEventFilter<FillLimitOrderCalledEvent>;

export interface FillRfqOrderCalledEventObject {
  order: LibNativeOrder.RfqOrderStructOutput;
  signatureType: number;
  v: number;
  r: string;
  s: string;
...
export type FillRfqOrderCalledEvent = TypedEvent<
  [
    LibNativeOrder.RfqOrderStructOutput,
    number,
    number,
    string,
    string,
  ...
  FillRfqOrderCalledEventObject
>;

export type FillRfqOrderCalledEventFilter =
  TypedEventFilter<FillRfqOrderCalledEvent>;
...
export interface TestMetaTransactionsNativeOrdersFeature extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestMetaTransactionsNativeOrdersFeatureInterface;
  ...
  filters: {
    "FillLimitOrderCalled(tuple,uint8,uint8,bytes32,bytes32,uint128,address,address)"(
      order?: null,
      signatureType?: null,
      v?: null,
      r?: null,
      s?: null,
      takerTokenFillAmount?: null,
      taker?: null,
      sender?: null
    ): FillLimitOrderCalledEventFilter;
    FillLimitOrderCalled(
      order?: null,
      signatureType?: null,
      v?: null,
      r?: null,
    ...
    "FillRfqOrderCalled(tuple,uint8,uint8,bytes32,bytes32,uint128,address)"(
      order?: null,
      signatureType?: null,
      v?: null,
      r?: null,
