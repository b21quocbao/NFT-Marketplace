...
export interface AuthorizableV06Interface extends utils.Interface {
  functions: {
...
export interface AuthorizableV06 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuthorizableV06Interface;
