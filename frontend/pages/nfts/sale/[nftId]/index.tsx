...
function SaleNftPage(props: any) {
  ...
  async function saleNftHandler(enteredNftData: any) {
    ...
    const makerAsset: any = {
      ...
      tokenId: props.nft.tokenId, // Token Id of the CryptoPunk we want to swap
      type: "ERC721", // Must be one of 'ERC20', 'ERC721', or 'ERC1155'
    };

    const takerAsset: any = {
      tokenAddress: "0xc778417E063141139Fce010982780140Aa0cD5Ab", // USDC contract address
      amount: enteredNftData.amount, // 69 USDC (USDC is 6 digits)
      type: "ERC20",
    };
